...
def test_retrieval_gap_generation_validation_pipeline(question_repository, audit_service, metrics_service, embedding_client, embedding_repository, gap_service, validation_service):
    ...
    result = asyncio.run(
        service.recommend(
            RecommendationRequest(
                prompt="Please add migration questions",
                top_k=5,
